...
| Associative | `see`, `related_concept`, `sequentially_related_concept`, `spatially_related_concept`, `temporally_related_concept` |
...
<figure>
  <img src="/images/model/concept-term-cycle.png" alt="The concept-term interaction cycle diagram from ISO 704" />
  <figcaption><strong>The concept–term interaction cycle.</strong> The iterative workflow: identify the concept and its characteristics, position it within the concept system, write or verify the definition, establish or select terms, and record the result — then repeat as the system evolves.</figcaption>
</figure>
