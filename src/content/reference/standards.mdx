...
- [ManagedConcept](/model/concepts), [LocalizedConcept](/model/concepts), [ConceptSource](/model/sources)
...
- [Concept-term interaction cycle](/model/)
...
- [TBX term types](/model/term-types)
...
- [Term type values](/model/term-types)
- Register values
- Part of speech
- Source status/type
