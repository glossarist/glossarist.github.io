...
ISO/TC 211, OGC, FAO, INSPIRE. SKOS mapping properties (`equivalent`, `close_match`, `broad_match`, `narrow_match`) for cross-vocabulary equivalence; ISO 19135 register lifecycle on every concept; UN-language coverage as a structural invariant.
