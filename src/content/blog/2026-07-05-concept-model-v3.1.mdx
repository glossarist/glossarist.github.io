...
See the new [Datasets & Sections](/model/datasets) page for the full register schema, transitive cascading, and the ordering-method taxonomy.
...
See the new [Non-verbal Entities](/model/non-verbal) page for the full hierarchy, the `FigureImage` role/format enums, and the rationale for the two-layer split.
...
The `related_concept_type` enum now covers **52 types** across ISO 10241-1, ISO 19135, ISO 25964, SKOS, ISO 12620, and TBX — a MECE set with explicit inverse pairs. See the [Relationship Types](/model/relationships) page for the full reference, organized by category.
...
- [Concept Model docs](/model/) — full entity reference
- [Datasets & Sections](/model/datasets) — register.yaml, sections, ordering, bibliography
- [Non-verbal Entities](/model/non-verbal) — Figure, Table, Formula
- [Relationships](/model/relationships) — 52 typed relationship kinds
