...
- You and/or concept system change submitters might want to read [Getting started with the desktop app](/docs/software/desktop/getting-started/installation)
