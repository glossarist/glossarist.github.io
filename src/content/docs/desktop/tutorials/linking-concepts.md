...
description: Specify concept relationships via the Relationships panel
---
...
2. Click the plus button on top of the Relationships panel and select the type of relationship you want to add.
