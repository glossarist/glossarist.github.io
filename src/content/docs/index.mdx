...
| I want to... | Go to |
|-------------|-------|
| Understand the concept model | [Concept Model Overview &rarr;](/model/) |
...
| Install the desktop app | [Installation Guide &rarr;](/docs/software/desktop/getting-started/installation) |
...
### [Desktop App](/docs/software/desktop/)
