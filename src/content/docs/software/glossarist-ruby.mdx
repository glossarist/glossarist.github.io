...
Ruby gem implementing the [Glossarist concept model](https://github.com/glossarist/concept-model/tree/main) in Ruby. All the entities in the [concept model](/model/) are available as classes and all the attributes are available as methods of those classes. The gem reads and writes Glossarist V2 and V3 datasets, packages them as portable GCR archives, and exports to TBX, SKOS, and Turtle with SHACL validation.
...
See [Non-verbal entities](/model/non-verbal) for the model details.
...
- [Concept Model docs](/model/) — the entity model this gem implements
...
- [Standards compliance](/reference/standards) — ISO standard mappings for TBX, SKOS, and Turtle export
