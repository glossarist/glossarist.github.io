...
description: Review proposed changes as register manager
---

# Reviewing a Change

Review proposed changes as register manager.

## Selecting a revision to review

1. Navigate to Review module
2. Using Change Requests panel on the left, select a change request you want to review
3. Using Proposed Revisions panel on the right, select a proposed concept entry revision to review

## Reviewing changes

Selected concept entry will be shown in the main module view. You can switch between viewing _revision with changes highlighted_ and _final revision_ using buttons in the toolbar on the bottom.
