...
At the core of Glossarist is a rich [concept model](/model/) aligned with multiple ISO standards:
...
See the [full standards compliance reference](/reference/standards) for details on how each standard maps to Glossarist entities.
...
1. **Explore the Concept Model** — Read the [Concept Model docs](/model/)
