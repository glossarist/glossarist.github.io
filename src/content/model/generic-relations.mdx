...
<figure class="g-figure-light">
  <img src="/images/hyperedge-computer-mouse.svg" alt="Generic hyperedge — computer mouse with two criteria of subdivision (ISO 704:2022 §5.5.4.2.1)" loading="lazy" />
  <figcaption>Generic hyperedge — ISO 704:2022 §5.5.4.2.1 canonical computer-mouse example with two criterion rakes and per-species delimiting characteristics.</figcaption>
</figure>
