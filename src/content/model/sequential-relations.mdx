...
| Shape | Use when … |
|-------|-----------|
| Binary `sequentially_related_concept` / `spatially_related_concept` / `temporally_related_concept` | Pairwise assertion with no completeness or multidimensionality claim |
