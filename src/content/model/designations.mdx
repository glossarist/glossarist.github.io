...
| `term_type` | [termType](/model/term-types) | 0..1 | ISO 12620 | Classification of the designation's term type |
...
| `sources` | [ConceptSource](/model/sources)[] | 0..* | ISO 10241-1 §6.8 | Bibliographic sources |
...
See the [YAML Schema Reference](/reference/schema-browser) for the complete JSON Schema definitions, the [Entity Field Reference](/reference/entity-fields) for all entity types, and the [Standards compliance reference](/reference/standards) for ISO standard mappings.
