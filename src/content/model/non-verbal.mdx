...
| `sources` | [ConceptSource](/model/sources)[] | 0..* | Bibliographic sources |
...
| `sources` | [ConceptSource](/model/sources)[] | 0..* | Per-reference sources |

## Inline figure mentions

Concepts reference dataset-level figures from running text via the fig mention syntax (analogous to the cite mention syntax for [sources](/model/sources#inline-citations)):
...
See the [Figure YAML schema](/reference/schema-browser) for the formal definition, the [Datasets & sections](/model/datasets) page for the surrounding dataset model, and the [Sources](/model/sources) page for the related cite mention syntax.
